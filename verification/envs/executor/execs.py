...
from executor.permissions import GUARDED_MODULES_FOLDER
from executor.utils import str_traceback, pformat_none, AttrDict
...
def _import_secure(*args, **kwargs):
    ...
    if os.path.exists(os.path.join(GUARDED_MODULES_FOLDER, 'r_' + args[0] + '.py')):
        return __import__('r_' + args[0], *args[1:], **kwargs)
...
#
# class DoneTest(RefereeException):
...
#
#
# class FailTest(RefereeException):
